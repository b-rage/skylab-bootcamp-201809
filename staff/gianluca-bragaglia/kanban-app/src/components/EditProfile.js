...
class EditProfile extends Component {
    ...
    handleSubmit = event => {
        ...
        this.props.onEditProfile(name, surname, username, newPassword, password)
    ...
    render() {
        return <form className='form-register' onSubmit={this.handleSubmit}>
            ...
            <br></br>
            <input className='input' type="password" placeholder="newPassword" onChange={this.handleNewPasswordChange} />
            <br></br>
